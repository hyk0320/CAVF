...
def parse_opt():
    ...
    training.add_argument('--group_dependency', default=False, help='add A module ?')
    training.add_argument('--version', type=str, default='v1', help='change experiment version')

    FCNet = parser.add_argument_group(title='FCNet Parameters')
    FCNet.add_argument('--is_FCNet', type=bool, default=False, help='which model to train and test')
    FCNet.add_argument('--FCNet_loss_weight', type=float, default=1, help='FCNet loss weight')

    BCNet = parser.add_argument_group(title='BCNet Parameters')
    BCNet.add_argument('--is_BCNet', type=bool, default=False, help='which model to train and test')
    BCNet.add_argument('--BCNet_loss1_weight', type=float, default=1, help='BCNet loss weight')
    BCNet.add_argument('--BCNet_loss2_weight', type=float, default=1, help='BCNet loss weight')

    visual_decoder = parser.add_argument_group(title='visual E-D Parameters')
    visual_decoder.add_argument('--is_visual_decoder', type=bool, default=False, help='which model to train and test')

    NAR_decoder = parser.add_argument_group(title='latent variant')
    NAR_decoder.add_argument('--is_NAR_decoder', type=bool, default=False, help='which model to train and test')
    NAR_decoder.add_argument('--NAR_loss_weight', type=float, default=1, help='visual_decoder loss weight')
    NAR_decoder.add_argument('--num_attention_heads_c', type=int, default=8, help='cross attention heads')

    Verb_decoder = parser.add_argument_group(title='verb parameter')
    Verb_decoder.add_argument('--is_verb_decoder', type=bool, default=False, help='predict verb first?')
    Verb_decoder.add_argument('--verb_num', type=int, default=1000, help='verb numbers')
    Verb_decoder.add_argument("--verb_loss_weight", type=float, default=1, help="verb predictor weight")
    ...
    evaluation.add_argument('--iterations', type=int, default=1,
    ...
    dataloader.add_argument('--verb_name', type=str, default='itov.pkl')
